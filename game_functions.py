...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets,
    ...
    # background
    background.blitme() # стало сильно тормозить!
...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    # Пуля двигается вверх по экрану
    bullets.update()
...
def ship_hit(ai_settings, screen, stats, 
    ...
    if stats.ships_left > 0:
        ...
        # Обновление игровой информации на экран.
        sb.prep_ships()
...
def update_aliens(ai_settings, screen, stats, 
                    sb, ship, aliens, bullets):
    """
